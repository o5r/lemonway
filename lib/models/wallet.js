...
module.exports = function (lemonway) {
  ...
  Wallet.extendPromise = function (walletPromise) {
    walletPromise.update = function (data) {
      return walletPromise.call('update', data);
    };

    walletPromise.close = function (data) {
      return walletPromise.call('close');
    };
  };
