...
WalletFactory.sendPayment = function (debitedWallet, creditedWallet, _opts) {
  var opts = _.assign({}, _opts, {
    debitedWallet: debitedWallet.id ? debitedWallet.id : debitedWallet,
    creditedWallet: creditedWallet.id ? creditedWallet.id : creditedWallet
  });
