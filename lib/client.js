...
function Client (login, pass, endpoint, options) {
  ...
  if (this.options.proxy) {
    this.options.httpClient = new ProxyHttpClient(this._endpoint, this.options.proxy);
  }
}
...
Client.prototype.updateWallet = function (ip, _opts) {
  var opts = _.assign({}, _opts, {
    wallet: _opts.id,
...
Client.prototype.getBalances = function (ip, _opts) {
  ...
  return this._request('GetBalances', ip, opts).get('WALLETS').get('WALLET');
};
...
Client.prototype.getWalletTransHistory  = function (ip, _opts) {
  ...
  return this._request('GetWalletTransHistory', ip, opts).get('TRANS').get('HPAY');
};
