...
Client.prototype._request = function (method, args, resultName) {
  ...
  return new Promise(function (resolve) {
    ...
    .then(function (result) {
      if (result.E) {
        if (errors.codes[_.get(result, 'E.Code')]) {
          throw new errors.codes[_.get(result, 'E.Code')]()
        }
...
Client.prototype.getMoneyInTransDetails = function (_opts) {
  var opts = _.assign({}, _opts, {
    version: '1.3',
    startDate: utils.dateToUnix(_opts.after) || 0,
    endDate: utils.dateToUnix(_opts.before)
  });
...
Client.prototype.getMoneyInIBANDetails = function (_opts) {
  var opts = _.assign({}, _opts, {
    version: '1.4',
    updateDate: utils.dateToUnix(_opts.after)
  });

  return this._request('GetMoneyInIBANDetails', opts).get('TRANS');
};
...
Client.prototype.getWalletTransHistory  = function (_opts) {
  var opts = _.assign({}, _opts, {
    version: '2.0',
    startDate: utils.dateToUnix(_opts.from),
