...
Client.prototype.updateWallet = function (_opts) {
  var opts = _.assign({}, _opts, {
    newEmail: _opts.clientMail,
    newTitle: _opts.clientTitle,
    newFirstName: _opts.clientFirstName,
    newLastName: _opts.clientLastName,
...
Client.prototype.moneyIn3DInit = function (_opts) {
  ...
  return this._request('MoneyIn3DInit', opts).get('MONEYIN3DINIT');
};
...
Client.prototype.moneyIn3DConfirm = function (_opts) {
  ...
  return this._request('MoneyIn3DConfirm', opts).get('MONEYIN').get('HPAY');
};
...
Client.prototype.moneyInWithCardId = function (_opts) {
  ...
  return this._request('MoneyInWithCardId', opts).get('TRANS').get('HPAY');
};

Client.prototype.moneyInValidate = function (_opts) {
  var opts = _.assign({}, _opts);

  return this._request('MoneyInValidate', opts).get('TRANS').get('HPAY');
};
...
Client.prototype.getKycStatus = function (_opts) {
  ...
  return this._request('GetKycStatus', opts).get('WALLETS').get('WALLET');
};
...
Client.prototype.moneyIn3DAuthenticate = function (_opts) {
  ...
  return this._request('MoneyIn3DAuthenticate', opts).get('WALLETS').get('WALLET');
};
...
Client.prototype.unregisterSddMandate = function (_opts) {
  ...
  return this._request('UnregisterSddMandate', opts).get('SDDMANDATE');
};
