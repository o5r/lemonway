...
var errors = [
  ...
  { className: 'TransactionMaxAmountReached', code: 109, message: 'Amount higher than the maximum limit', description: 'Transaction amount is higher than the maximum amount authorized' },
