...
var errors = [
  ...
  { className: 'AmountNotAllowed', code: 151, message: 'Amount not allowed', description: 'higher than refundable amount, or lower than 0.50€ for a card payment, not allowed according to your contract, or too high. Please contact support' },
  ...
  { className: 'FileError', code: 234, message: 'File too big or wrong format' },
  ...
  { className: 'DocumentAlreadyInReview', code: 241, message: 'A document of same type is already pending review by LW\'s KYC services' },
  ...
  { className: 'SDDMandateInvalid', code: 245, message: 'SDD mandate invalid' },
  { className: 'SDDMandateAlreadyInUse', code: 246, message: 'SDD mandate currently already in use for a direct debit' },
