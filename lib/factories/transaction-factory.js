...
function TransactionFactory (lemonway) {
  ...
  this.Transaction = function Transaction (data) {
    ...
    this.date = moment(data.DATE, 'DD/MM/YYYY hh:mm:ss').toDate();
...
TransactionFactory.prototype.refundMoneyIn = function (transaction, _opts) {
  ...
  var transactionPromise = this._lemonway._client.refundMoneyIn(opts)
    .bind(this)
    .then(function (data) {
      return new this.Transaction(data);
    });
...
TransactionFactory.prototype.listMoneyIn =
  function (_opts) {
    var opts = _.assign({}, _opts);
...
TransactionFactory.prototype.listMoneyOut =
  function (_opts) {
    var opts = _.assign({}, _opts);
...
TransactionFactory.prototype.getMoneyIn
